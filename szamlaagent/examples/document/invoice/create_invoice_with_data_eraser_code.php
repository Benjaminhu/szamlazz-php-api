...
/**
 * Ez a példa megmutatja, hogy hogyan hozzunk létre egy számlát adattörlő kód hozzáadásával.
 */
...
try {
    ...
    /**
     * Új papír alapú számla létrehozása adattörlő kóddal
     *
    ...
    // Adattörlő kód darabszámának beállítása
    $item->setDataDeletionCode(1);
